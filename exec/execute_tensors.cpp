...
int main(int argc, char **argv) {
  ...
  TensorDim1 TD1_2("3x1_0", 3);
  TD1_2.Print();
  TensorDim1 TD1_3("3x1_1", 3);
  TD1_3.Print();
  ...
  TensorDim1 TD2_CP = CrossProd(TD1_2, TD1_3);
  TD2_CP.Print();
  std::cout << "--- Substraction" << std::endl;
  TensorDim1 TD1_sub = TD1_0 - TD1_1;
  TD1_sub.Print();
  std::cout << "--- Addition" << std::endl;
  TensorDim1 TD1_add = TD1_0 + TD1_1;
  TD1_add.Print();
  TensorDim2 TD2_D0 = DiracMatrix(0);
  TensorDim2 TD2_D1 = DiracMatrix(1);
  TensorDim2 TD2_D2 = DiracMatrix(2);
  TensorDim2 TD2_D3 = DiracMatrix(3);
  TensorDim2 TD2_D5 = DiracMatrix(5);
  TD2_D0.Print();
  TD2_D1.Print();
  TD2_D2.Print();
  TD2_D3.Print();
  ...
  TensorDim2 TD2_DM0 = SlashDirac(TD1_0);
  TD2_DM0.Print();
  TensorDim2 TD2_DM1 = SlashDirac(TD1_1);
  TD2_DM1.Print();
  
  std::cout << "--- Substraction" << std::endl;
  TensorDim2 TD2_sub = TD2_DM0 - TD2_DM1;
  TD2_sub.Print();
  std::cout << "--- Addition" << std::endl;
  TensorDim2 TD2_add = TD2_DM0 + TD2_DM1;
  TD2_add.Print();
  
  std::cout << "--- Matrix Multiplication" << std::endl;
  TensorDim2 TD2_mult = TD2_DM0 * TD2_DM1;
  TD2_mult.Print();
  std::cout << "--- Vector Multiplication" << std::endl;
  TensorDim1 TD1_mult_1 = TD2_DM1 * TD1_add;
  TD1_mult_1.Print();
  

  TensorDim3 TD3_0("4x3_0", 4);
  TD3_0.Print();
  TensorDim3 TD3_1("4x3_1", 4);
  TD3_1.Print();
  ...
  TensorDim3 TD3_add = TD3_0 + TD3_1;
  TD3_add.Print();
  TensorDim3 TD3_sub = TD3_0 - TD3_1;
  TD3_sub.Print();

  TensorDim3 TD3_mult = cu * TD3_0;
  TD3_mult.Print();


  TensorDim4 TD4_0("4x4_0",4);
  TD4_0.Print();

  TensorDim4 TD4_1("4x4_1",4);
  TD4_1.Print();
  ...
  TensorDim4 TD4_add = TD4_0 + TD4_1;
  TD4_add.Print();
  TensorDim4 TD4_sub = TD4_0 - TD4_1;
  TD4_sub.Print();
  TensorDim4 TD4_mult = cu * TD4_0;
  TD4_mult.Print();
    return 1;
